    ...
    actions: {
        ...
        async login({email, password}: LoginData) {
            ...
            try {
                ...
                this.login = new Wrapper().toLoading();
        ...
        async register({email, password, firstName, lastName}: RegistrationData) {
            ...
            try {
                this.user = new Wrapper().toLoading();
                this.register = new Wrapper().toLoading();
        ...
        async updateUserInfo(payload: UpdateUserRequest, onDone?: Function) {
            try {
                ...
                const response = await (<HttpClient>$http).put(
        ...
        async changeUserPassword(
            ...
            try {
                //@ts-ignore
                this.changePassword = new Wrapper<
                    SingleApiResponse<User>
                >().toLoading();
                const {$http} = useNuxtApp();
                const response = await (<HttpClient>$http).put(
                    `${Endpoint.users}/${useAuthStore().authUser?.id}`,
        ...
        async getUser() {
            ...
            try {
                ...
                this.fetchUser = new Wrapper<User>().toFailed();
