export const enum AnalyticsEvent {
  ...
  browseFlutterPageButtonClicked = "browse_flutter_page_button_clicked",
  browseFluppetsPageEntered = "browse_fluppets_page_entered",
  consulterFluppetsPageEntered = "consulter_fluppets_page_entered",
  fluppetsCreateFluppetsButtonClicked = "fluppets_create_fluppets_button_clicked",
}
