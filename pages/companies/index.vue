...
<template>
  <main>
    <section class="relative bg-blueGray-50 overflow-hidden">
      <img alt="" class="absolute left-1/2 bottom-0 transform" src="@/assets/images/gradient6.svg" />
      <div class="container px-4 py-16 mx-auto">
        <div class="flex flex-col items-center justify-center p-8">
          ...
          <p class="mb-11 text-lg text-gray-900 font-medium text-center">
            Unleash your work-from-anywhere potential! Explore top remote companies and
            their cultures, missions, and open positions.
          </p>
        </div>
      </div>
    </section>
