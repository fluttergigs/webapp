      ...
      <template #form>
        <form class="space-y-4">
          <div class="flex space-x-4 mb-5 w-full">
            <CustomInput v-model="formInput.name" class="w-full" name="name" placeholder="Company name" />
            <CustomInput v-model="formInput.website" :show-label="false" class="w-full" label="Website" name="url"
