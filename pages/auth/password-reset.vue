<template>
  <main>
    <BasicFormContent description="Reset your password" show-close-button title="Welcome Back">
      <template #form>
        <form class="space-y-4">
          <div class="block mb-5">
            <CustomInput
              v-model="resetPasswordDataInput.password"
          ...
          <div class="block mb-5">
            <CustomInput
              v-model="resetPasswordDataInput.passwordConfirmation"
              :type="passwordFieldType"
              autocomplete="new-password"
