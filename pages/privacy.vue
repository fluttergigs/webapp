    ...
    <div class="container mx-auto px-4 py-12 max-w-4xl"><h1 class="text-3xl font-heading font-bold mb-8">
      ...
      <div class="space-y-8">
        <section><p class="text-sm  mb-8">Last updated: February 13, 2025</p>
          <p class="leading-relaxed mb-4"> At FlutterGigs, we take your privacy seriously. This Privacy Policy explains
            how
            we collect, use, and protect your personal information when you use our platform. </p></section>
        <section><h2 class="text-2xl font-heading font-semibold  mb-4">Information We Collect</h2>
          <div class="space-y-4">
            <div><h3 class="text-lg font-medium mb-2">Account Information</h3>
            ...
            <div><h3 class="text-lg font-medium mb-2">Usage information</h3>
              <p>We collect information about how you use FlutterGigs, including:</p>
              <ul class="list-disc list-inside ml-4 mt-2">
                <li>Job offers you submit</li>
                <li>Code snippets you create and share</li>
        ...
        <section><h2 class="text-2xl font-heading font-semibold  mb-4">How we use your information</h2>
        ...
        <section><h2 class="text-2xl font-heading font-semibold  mb-4">Data security</h2>
          <p class="leading-relaxed"> We implement appropriate security measures to protect your personal information.
            However, no method of transmission over the internet is 100% secure, and we cannot guarantee absolute
            security. </p></section>
        <section><h2 class="text-2xl font-heading font-semibold  mb-4">Your rights</h2>
