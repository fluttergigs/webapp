      ...
      <div class="inset-0 max-w-xs bg-blueGray-50 border-r fixed transition-all ease-in">
        ...
        <div class="flex-1 flex flex-col justify-between py-8 overflow-x-hidden overflow-y-auto">
          <div class="flex flex-col flex-wrap px-7 mb-8 -m-2.5">
            ...
            <div class="w-auto p-2.5">
              <p class="text-xs text-neutral-400 font-medium uppercase mb-4">Employer</p>
              <a
                  class="flex flex-wrap items-center space-x-3" href="#">
                <BuildingOffice2Icon class="text-gray-600 w-5 h-5"/>
                <p class="hover:text-neutral-700 font-medium">Company</p>
              </a>
            </div>
            <div class="w-auto p-2.5">
              <a class="flex flex-wrap items-center space-x-3" href="#">
            ...
            <div class="w-auto p-2.5">
              <p class="text-xs text-neutral-400 font-medium uppercase mb-4">Account</p>
              <a
                  class="flex flex-wrap items-center space-x-3" href="#">
                <UserIcon class="text-gray-600 w-5 h-5"/>
                <p class="hover:text-neutral-700 font-medium">User Settings</p>
              </a>
            </div>
                    ...
                    <div class="flex flex-wrap items-center justify-between px-7 -m-2">
                      <div class="w-auto p-2">
                        <div class="flex flex-wrap -m-1.5">
                          <div class="w-auto p-1.5"><img src="dashy-assets/images/avatar.png" alt=""></div>
