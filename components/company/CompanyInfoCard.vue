...
<template>
  <div
    v-if="isCompanyFeatureEnabled"
    class="p-6 border rounded-xl space-y-5 flex flex-col"
  ...
  >
    ...
    <ItemData
      v-if="useCompanyActions().hasSocialMedia(props.company as Company)"
      label="Social Media"
    >
      <template #content>
        <div class="flex items-center space-x-2">
          <a
            v-if="!!props.company?.linkedin"
