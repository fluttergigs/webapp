      ...
      <div class="flex flex-wrap lg:items-center -m-8">
        <div class="w-full md:w-1/2 p-8">
          <div class="md:max-w-lg">
            ...
            <p class="font-medium text-gray-600 leading-relaxed">
              With our easy-to-use platform, you can post your
        ...
        <div class="w-full md:w-1/2 p-8">
          <div class="md:max-w-md mx-auto overflow-hidden rounded-3xl shadow-8xl">
            <div class="p-9">
              <span
                  class="mb-7 inline-block text-sm text-gray-500 font-semibold uppercase tracking-px">Features included:</span>
              <ul>
                ...
                <div class="w-full sm:w-1/2 p-8">
                  <div class="sm:max-w-max ml-auto">
                    <p class="font-bold">
                      ...
                      <span class="text-lg text-gray-500 leading-snug tracking-px-n">/job offer</span>
                    </p>
